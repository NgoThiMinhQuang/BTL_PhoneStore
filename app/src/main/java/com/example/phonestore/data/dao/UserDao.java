...
public class UserDao {
    ...
    private String buildCustomersQuery(String keyword) {
        String sql = "SELECT u." + DBHelper.COL_ID + "," +
                ...
                " COALESCE(SUM(CASE WHEN o." + DBHelper.COL_O_ORDER_STATUS + "='" + OrderStatus.STATUS_DA_GIAO + "' AND o." + DBHelper.COL_O_PAYMENT_STATUS + "='DA_THANH_TOAN' THEN o." + DBHelper.COL_O_TOTAL + " ELSE 0 END), 0) AS delivered_spend" +
